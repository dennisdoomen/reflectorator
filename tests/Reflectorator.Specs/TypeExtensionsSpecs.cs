    ...
    public class TypeMemberReflectorSpecs
    {
        public class GetProperties
        {
            ...
            public void Can_get_default_interface_properties_only()
            {
                // Act
                var reflector =
                    new TypeMemberReflector(typeof(SuperClass), MemberVisibility.DefaultInterfaceProperties);
        ...
        public class GetFields
        {
            ...
            public void Can_find_all_fields()
            {
                // Act
                var reflector = new TypeMemberReflector(typeof(SuperClass),
                    MemberVisibility.Internal | MemberVisibility.Public);
...
#pragma warning restore CS0649 // Field is never assigned to, and will always have its default value
        ...
        private class ClassWithExplicitAndNormalProperty : IInterfaceWithSingleProperty
        {
            ...
            [UsedImplicitly] public int ExplicitlyImplementedProperty { get; set; }
        }

        private class BaseClass
        {
            [UsedImplicitly] public string NewProperty { get; set; }
        }

        private interface IInterfaceWithDefaultProperty : IInterfaceWithSingleProperty
        {
            [UsedImplicitly] string InterfaceProperty { get; set; }

            [UsedImplicitly] string DefaultProperty => "Default";
        }

        private interface IInterfaceWithSingleProperty
        {
            [UsedImplicitly] string ExplicitlyImplementedProperty { get; set; }
        }

        private class ClassWithIndexer
        {
            [UsedImplicitly] public object Foo { get; set; }
